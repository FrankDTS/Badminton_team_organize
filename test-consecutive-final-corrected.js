...
const totalViolations = result1.violations + result2.violations
...
if (totalViolations > 0) {
  ...
  console.log(`private courtLastUsage: Map<string, { teamKey: string, gameNumber: number }> = new Map()`)
  console.log(``)
  console.log(`// 修正檢測函數`)
  console.log(`public isConsecutiveSameTeamOnSameCourt(...) {`)
  console.log(`  const teamKey = [...playerIds].sort().join('-')`)
  console.log(`  const lastUsage = this.courtLastUsage.get(courtId)`)
  console.log(`  if (!lastUsage) return false`)
  console.log(`  return lastUsage.teamKey === teamKey`)
  console.log(`}`)
} else {
